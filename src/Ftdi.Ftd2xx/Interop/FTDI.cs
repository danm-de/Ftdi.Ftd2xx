...
using Ftdi.Ftd2xx.Interop.Eeprom;
    ...
    internal class FTDI
    {
        ...
        public FT_STATUS OpenBySerialNumber(string serialnumber)
        {
                ...
                (pFT_SetFlowControl != IntPtr.Zero) & (pFT_SetBaudRate != IntPtr.Zero))
            {
                ...
                // Call FT_OpenEx
                ftStatus = FT_OpenEx(serialnumber, (uint) FT_OPENEX.FT_OPEN_BY_SERIAL_NUMBER, ref ftHandle);
        ...
        public FT_STATUS OpenByDescription(string description)
        {
                ...
                (pFT_SetFlowControl != IntPtr.Zero) & (pFT_SetBaudRate != IntPtr.Zero))
            {
                ...
                // Call FT_OpenEx
                ftStatus = FT_OpenEx(description, (uint) FT_OPENEX.FT_OPEN_BY_DESCRIPTION, ref ftHandle);
        ...
        public FT_STATUS OpenByLocation(uint location)
        {
                ...
                (pFT_SetFlowControl != IntPtr.Zero) & (pFT_SetBaudRate != IntPtr.Zero))
            {
                ...
                // Call FT_OpenEx
                ftStatus = FT_OpenEx(location, (uint) FT_OPENEX.FT_OPEN_BY_LOCATION, ref ftHandle);
